...
let CategoriesController = class CategoriesController {
    ...
    async getCategories(user) {
        ...
        return categories.map(serializers_1.serializeCategory);
    }
    async createCategory(user, dto) {
        const category = await this.categoriesService.createForUser(user.userId, dto);
        return (0, serializers_1.serializeCategory)(category);
    }
};
